        ...
        <div className="container-fluid services py-5">
            <div className="container text-center py-5">
                <div className="text-center mb-5 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h1 className="display-5">Our Featured Services</h1>
                ...
                <div className="row g-5" style={{'--bs-gutter-x': '0.1rem' }}>
                    ...
                    <div className="col-xxl-2 col-lg-4 col-md-6 col-sm-12 mx-auto wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div className="col-xxl-2 col-lg-4 col-md-6 col-sm-12 mx-auto wow fadeInUp" data-wow-delay=".5s">
                        <div className="bg-light rounded p-5 services-item">
                            <div className="d-flex" style={{ alignItems: 'center', justifyContent: 'center', display: 'flex' }}>
                                <div className="mb-4">
                            ...
                            <h4 className="text-center">Cooks</h4>

                        </div>
                    </div>
                    <div className="col-xxl-2 col-lg-4 col-md-6 col-sm-12 mx-auto wow fadeInUp" data-wow-delay=".7s">
                        <div className="bg-light rounded p-5 services-item">
                            <div className="d-flex" style={{ alignItems: 'center', justifyContent: 'center', display: 'flex' }}>
                                <div className="mb-4">
                            ...
                            <h4 className="text-center">Babysitter</h4>

                        </div>
                    </div>
                    <div className="col-xxl-2 col-lg-4 col-md-6 col-sm-12 mx-auto wow fadeInUp" data-wow-delay=".9s">
                        <div className="bg-light rounded p-5 services-item">
                            <div className="d-flex" style={{ alignItems: 'center', justifyContent: 'center', display: 'flex' }}>
                                <div className="mb-4">
                            ...
                            <h4 className="text-center">All-rounders</h4>
                    ...
                    <div className="col-xxl-2 col-lg-4 col-md-6 col-sm-12 mx-auto wow fadeInUp" data-wow-delay=".9s">
                        <div className="bg-light rounded p-5 services-item">
                            ...
                            <h4 className="text-center">24 Hrs - Live In</h4>
